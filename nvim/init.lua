...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sF', function () builtin.find_files({ no_ignore = true, }) end, { desc = '[s]earch [F]iles (including ignored)' })
      vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[s]earch [s]elect Telescope' })
      vim.keymap.set('n', '<leader>sw', builtin.grep_string, { desc = '[s]earch current [w]ord' })
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[s]earch by [g]rep' })
      -- TODO this does not seem to work 
      vim.keymap.set('n', '<leader>sG', function () builtin.live_grep({ additional_args = { '--no-ignore' }, }) end, { desc = '[s]earch by [G]rep (including ignored)' })
